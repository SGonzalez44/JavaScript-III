...
*/
function CharacterStat(game) {
  GameObject.call(this, game);
  this.healthPoints = game.healthPoints
}
CharacterStat.prototype = Object.create(GameObject.prototype);
...
function Humanoid(game) {
  CharacterStat.call(this, game);
  this.team = game.team;
  this.weapons = game.weapons;
  this.language = game.language;
} 
Humanoid.prototype = Object.create(CharacterStat.prototype);
